...
namespace PeopleReportPlugin.Admin
{
    ...
    /// </summary>
    public class PeopleReportPluginItemManager : ItemManager
    {
        private PeopleReportPluginUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public PeopleReportPluginItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new PeopleReportPluginUserControl();
        ...
        {
            return new PeopleReportPluginAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(PeopleReportPluginDefinition.PeopleReportPluginPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((PeopleReportPluginAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(PeopleReportPluginDefinition.PeopleReportPluginPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(PeopleReportPluginDefinition.PeopleReportPluginPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(PeopleReportPluginDefinition.PeopleReportPluginPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(PeopleReportPluginDefinition.PeopleReportPluginPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(PeopleReportPluginDefinition.PeopleReportPluginPluginId, _kind, fqid.ObjectId);
            return item;
        }
