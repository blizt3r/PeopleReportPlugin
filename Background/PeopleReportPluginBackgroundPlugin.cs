...
namespace PeopleReportPlugin.Background
{
    ...
    /// </summary>
    public class PeopleReportPluginBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return PeopleReportPluginDefinition.PeopleReportPluginBackgroundPlugin; }
        }
        ...
        {
            get { return "PeopleReportPlugin BackgroundPlugin"; }
        }
        ...
        public override void Init()
        {
            ...
            _thread.Name = "PeopleReportPlugin Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "PeopleReportPlugin background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "PeopleReportPlugin background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}
