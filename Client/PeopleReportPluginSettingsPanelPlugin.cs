...
{
    public class PeopleReportPluginSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return PeopleReportPluginDefinition.PeopleReportPluginSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "PeopleReportPlugin"; } }
        ...
        {
            _userControl = new PeopleReportPluginSettingsPanelControl(this);
            return _userControl;
        }
