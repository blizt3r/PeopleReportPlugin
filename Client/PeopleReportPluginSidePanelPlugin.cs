...
namespace PeopleReportPlugin.Client
{
    ...
    /// </summary>
    public class PeopleReportPluginSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new PeopleReportPluginSidePanelUserControl();
        //}
        ...
        {
            return new PeopleReportPluginSidePanelWpfUserControl();
        }
        ...
        {
            get { return PeopleReportPluginDefinition.PeopleReportPluginSidePanel; }
        }
        ...
        {
            get { return "PeopleReportPlugin Side panel"; }
        }
