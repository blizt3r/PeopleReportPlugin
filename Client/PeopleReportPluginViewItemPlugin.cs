...
namespace PeopleReportPlugin.Client
{
    ...
    /// </summary>
    public class PeopleReportPluginViewItemPlugin : ViewItemPlugin
    {

        public PeopleReportPluginViewItemPlugin()
        {
        }
        ...
        {
            get { return PeopleReportPluginDefinition.PeopleReportPluginViewItemPlugin; }
        }
        ...
        {
            return new PeopleReportPluginViewItemManager();
        }
