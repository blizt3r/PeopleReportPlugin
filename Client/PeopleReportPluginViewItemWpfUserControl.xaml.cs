...
namespace PeopleReportPlugin.Client
{
    ...
    /// </summary>
    public partial class PeopleReportPluginViewItemWpfUserControl : ViewItemWpfUserControl
    {
        #region Component private class variables

        private PeopleReportPluginViewItemManager _viewItemManager;
        ...
        /// <summary>
		/// Constructs a PeopleReportPluginViewItemUserControl instance
        /// </summary>
		public PeopleReportPluginViewItemWpfUserControl(PeopleReportPluginViewItemManager viewItemManager)
        {
