...
{
    public class PeopleReportPluginWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return PeopleReportPluginDefinition.PeopleReportPluginWorkSpacePluginId; }
        }
        ...
        public override void Init()
        {
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(1, new PeopleReportPluginWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
